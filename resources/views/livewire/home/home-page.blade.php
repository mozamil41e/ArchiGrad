    ...
    <section class="bg-gradient-to-br from-blue-50 to-white py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="max-w-2xl mx-auto">
                <form action="{{ route('projects-live.index') }}" method="get" class="relative" >
                    <input
                        type="text"
                        name="search"
    ...
    <section class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Link 1: البحث -->
                <a wire:navigate href="{{ route('projects-live.index') }}" class="group block p-6 bg-gradient-to-br from-blue-50 to-white border border-gray-200 rounded-lg hover:shadow-lg transition-all duration-300">
                ...
                <!-- Link 2: التصنيفات -->
                <a wire:navigate href="{{ route('home.categorys') }}" class="group block p-6 bg-gradient-to-br from-green-50 to-white border border-gray-200 rounded-lg hover:shadow-lg transition-all duration-300">
