<x-layout.app>
    ...
    <div x-data="projectDetails()" >
            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-reverse space-x-2">
                        ...
                        <li>
                            <a wire:navigate onclick="history.back()" class="text-gray-500 hover:text-blue-600 transition">البحث</a>
                        </li>
                        <li>
                            <span class="text-gray-400 mx-2">/</span>
                        </li>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <!-- Back Button -->
            <div class="mb-6">
                <a wire:navigate onclick="history.back()" class="inline-flex items-center text-blue-600 hover:text-blue-700 transition">
