<x-layout.app>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-reverse space-x-2">
                    <li>
                        <a href="{{ route('home.reports') }}" class="text-gray-500 hover:text-blue-600 transition">الرئيسية</a>
                    </li>
                    <li>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('projects.index') }}" class="inline-flex items-center text-blue-600 hover:text-blue-700 transition">
